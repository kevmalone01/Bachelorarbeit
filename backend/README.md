...
This directory contains the Flask based API used by the Document Processing System. The application uses SQLAlchemy for data persistence and Flask-Migrate for migrations.
...
| `/api/users/settings/<user_id>` | PUT | Update user settings and preferences |
